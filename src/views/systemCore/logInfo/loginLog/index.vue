	...
	<div class="p-2 page-layout-fill">
		...
		<el-card shadow="hover" class="page-card-fill">
			...
			>
				...
				/>
				<el-table-column label="客户端" align="center" prop="clientKey" />
				<el-table-column label="设备类型" align="center">
					<template #default="scope">
						<dict-tag :options="sys_device_type" :value="scope.row.deviceType" />
					</template>
				</el-table-column>
				<el-table-column label="地址" align="center" prop="ipaddr" />
...
const getList = async () => {
	...
	// console.log('🚀 ~ getList ~ loginInfoList.value:', loginInfoList.value);
