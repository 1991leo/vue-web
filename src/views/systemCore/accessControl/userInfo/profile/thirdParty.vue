<template>
	<div>
		<el-table :show-overflow-tooltip="true" :data="auths" style="width: 100%; height: 100%; font-size: 14px">
			...
			<el-table-column label="系统账号" width="180" align="center" prop="userName" />
