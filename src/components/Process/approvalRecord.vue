		...
		>
			<el-tabs v-model="tabActiveName" class="demo-tabs">
				...
				<el-tab-pane v-loading="loading" label="审批信息" name="info">
					<div>
						<el-table :show-overflow-tooltip="true" :data="historyList" style="width: 100%" fit>
							<el-table-column type="index" label="序号" align="center" width="60"></el-table-column>
							<el-table-column prop="nodeName" label="任务名称" sortable align="center"></el-table-column>
							<el-table-column prop="approveName" label="办理人" sortable align="center">
							...
							<el-table-column prop="createTime" label="开始时间" width="160" sortable align="center"></el-table-column>
							<el-table-column prop="updateTime" label="结束时间" width="160" sortable align="center"></el-table-column>
							<el-table-column
								prop="runDuration"
								label="运行时长"
								width="140"
							...
							<el-table-column prop="attachmentList" width="120" label="附件" align="center">
								<template #default="scope">
									...
									>
										...
										<el-table :show-overflow-tooltip="true" :data="scope.row.attachmentList">
											<el-table-column prop="originalName" width="202" label="附件名称"></el-table-column>
											<el-table-column prop="name" width="80" align="center" label="操作">
